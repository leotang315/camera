...
int main (int argc, char** argv) {
  ...
  if (argc==2 && !strcmp(argv[1],"demo")) {
    ...
    process("aloe_left.pgm",    "aloe_right.pgm");
    process("raindeer_left.pgm","raindeer_right.pgm");
    process("urban1_left.pgm",  "urban1_right.pgm");
    process("urban2_left.pgm",  "urban2_right.pgm");
    process("urban3_left.pgm",  "urban3_right.pgm");
